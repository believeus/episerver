		...
		<jsp:include page="header.jsp"></jsp:include>
			...
			<div style="width: 96%;height: auto;margin: 0 auto; overflow: hidden;">
				...
				<div style="width: 100%;height: auto;">
					<div style="width: 70%;height: auto;float: left;font-weight: 700;font-family: arial;">Importance of filling out questionnaires</div>
					<div style="width: 30%;height: auto;float: left;"><img src="static/images/ques1.png"style="width: 100%;height: ;"/></div>
			...
			<div style="width: 100%;height: 100%;">
			<div style="width: 96%;height: auto;overflow: hidden;">
				<div style="width: 100%;height: 20px;"></div>
				<div style="width: 100%;height: auto;">
					<div style="width: 70%;height: auto;float: left;font-weight: 700;font-family: arial;">How do we conduct data analysis</div>
					<div style="width: 30%;height: auto;float: left;"><img src="static/images/ques2.png"style="width: 100%;height: ;"/></div>
					<div style="width: 100%;height: 30px;"></div>
					<div style="width: 100%;height: auto;color: #666666;">
			...
			<div style="width: 100%;height: 100%;">
			<div style="width: 96%;height: auto;overflow: hidden;background-color: #F6F8F9;">
				<div style="width: 100%;height: 20px;"></div>
				<div style="width: 100%;height: auto;">
					<div style="width: 70%;height: auto;float: left;font-weight: 700;font-family: arial;">How do we ensure that information is confidential</div>
					<div style="width: 30%;height: auto;float: left;"><img src="static/images/ques3.png"style="width: 100%;height: ;"/></div>
					<div style="width: 100%;height: 30px;"></div>
					<div style="width: 100%;height: auto;color: #666666;">
			...
			<div style="width: 96%;height: auto;overflow: hidden;">
				...
				<div style="width: 100%;height: auto;">
					<div style="width: 70%;height: auto;float: left;font-weight: 700;font-family: arial;">How do we ensure that information is confidential</div>
					<div style="width: 30%;height: auto;float: left;"><img src="static/images/ques4.png"style="width: 100%;height: ;"/></div>
					<div style="width: 100%;height: 30px;"></div>
					<div style="width: 100%;height: auto;color: #666666;">
