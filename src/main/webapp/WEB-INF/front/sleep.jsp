...
slider.on("slide", function(slideEvt) {
	...
	<body>
		<div id="container"style="width: 100%;height: 100%;background-color: #2DB4A5;">
		<jsp:include page="header.jsp"></jsp:include>
			...
			<div id="content"style="width: 100%;height: auto;background-color: #2DB4A5">
  			...
  			<div class="ques4"style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;">
					<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;">
						4.Thinking about a typical night in the last month, how would you rate your sleep 
					</div>
					<div class="scroll-bar"style="width: 90%;height: auto;margin: 0 auto;">
						<div style="width: 100%;height: 20px;"></div>
