		...
		<div style="width: 100%;height: 100%;">
			...
			<div id="bio"style="width: 100%;height: auto; background-color: #F0F0F0;position: relative;">
				...
				<div class="bio-con"style="width: 100%;height:auto ;background-color: #F0F0F0;">
					...
					<p style="font-family: arial; color: #666666;">
						Only 1ml saliva samle is needed for detection,which is convenient and safe. 
						<br /> The sample will be sent to the laboratory for detection  in the form of cash on delivery,<br /> and then the test result will be sent to you throught the APP, and we will follow up your results in all aspects
					</p>
					<div style="width: 100%;height: 20px;"></div>
				</div>
			...
			<div id="app"style="width: 100%;height: auto;background-color: #036EB7; ">
				...
				<div style="width: 96%;height: auto;margin: 0 auto; color: white; font-size: 12px;">
					<div style="margin: 0 auto;margin-bottom: 8px; font-size: large;">
						Our intelligent APP system
					</div>
			...
			<div id="sam-e"style="width: 100%;height: 800px;">
				...
				<img src="static/images/hm7.png"style="width: 100%;height: auto;" /> </div>
				...
				<div id="intro-sam"style="width: 100%;height: auto;background-color: #F4F4F6; ">
					<div style="width: 100%;height: auto;">
						...
						<div style="width: 96%;height: auto;margin: 0 auto;font-family: arial; font-weight: 600;">
