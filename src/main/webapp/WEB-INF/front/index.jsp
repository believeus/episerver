	...
	<div style="width: 100%;height: 100%;">
		...
		<div id="bio" style="width: 100%;height: auto; background-color: #F0F0F0;position: relative;">
			...
			<div class="bio-title" style="width: 100%;height:60px ;">
				<div style="width: 57%;height: auto;float: left; line-height: 27px;font-size: large; font-weight: 700; font-family: arial;">Biological Age Detection of DNA Methylation</div>
			...
			<div class="bio-con" style="width: 100%;height:auto ;background-color: #F0F0F0;">
				...
				<p style="font-family: arial; color: #666666;">
					Only 1ml saliva samle is needed for detection,which is convenient and safe. <br /> The sample will be sent to the laboratory for detection in the form of cash on delivery,<br /> and then the test result will be sent to you throught the APP, and we will follow up your results in all aspects
				</p>
				<div style="width: 100%;height: 20px;"></div>
			</div>
		...
		<div id="app" style="width: 100%;height: auto;background-color: #036EB7; ">
			...
			<div style="width: 96%;height: auto;margin: 0 auto; color: white; font-size: 12px;">
				<div style="margin: 0 auto;margin-bottom: 8px; font-size: large;">Our intelligent APP system</div>

				<div id="dot">Internationally renowned exports patent research results</div>
				<div id="dot">Dynamic personal reporting</div>
				<div id="dot">Unique questionnaire system</div>
				<div id="dot">Intervention and continuous follow-up programmes</div>
		...
		<div id="sam-e" style="width: 100%;height: 800px;">
			...
			<div id="sam-e-con" style="width: 100%;height: auto;font-size: 12px; ">
				<div style="width: 96%;height: auto;margin: 0 auto; font-family: arial;color: #666666;">
					...
					<div style="width: 100%;height: 20px;"></div>
					<div id="blue-dot">The level of SAM-e decreases as the body ages. Concomitantly, a number of health issues, including mood, joint, and liver disorders are likely to occur</div>
					<div style="width: 100%;height: 20px;"></div>
					<div id="blue-dot">All SAM-e molecules have two forms: the SS (active) isomer and the RS (inactive) isomer.</div>
					<div style="width: 100%;height: 20px;"></div>
					<div id="blue-dot">While SAM-e comes in two stable salt forms; tosylate and butane disulphanate, only the tosylate form is backed by twenty years of research for safety and effectiveness</div>
				</div>
			</div>
			<div id="intro-sam" style="width: 100%;height: auto;background-color: #F4F4F6; ">
				<div style="width: 100%;height: auto;">
					...
					<div style="width: 96%;height: auto;margin: 0 auto;font-family: arial; font-weight: 600;">According to clinical studies,sam-e can improve emotional health, joint relaxation and liver function</div>
					<div class="blank" style="width: 100%;height: 30px;background-color: #F4F4F6 ; "></div>
				</div>
				...
				<div style="width: 100%;height: auto;background-color: #F4F4F6;overflow: hidden; ">
					<div style="width: 95%;height:auto;margin: 0 auto;border-top: 9px; align-content: center;background-color: #C1E1E8;border-radius: 10px;">
						<br />In March of 2003, the AHRQ (Agency for Healthcare Research and Quality) a division of the United States Health and Human Services, released the findings of a major study on SAM-e. <br /> <i style="color: #4A9ACA;"><a href="https://www.ncbi.nlm.nih.gov/books/NBK11886/" target="_blank">https://www.ncbi.nlm.nih.gov/books/NBK11886/</a></i>
					</div>
					...
					<div style="width: 100%;height: auto;">
						<div style="width: 96%;height: auto;margin: 0 auto;font-family: arial; color: #666666;">
							<div style="width:100%;height:auto;margin:0 auto;">
								<div id="blue-dot">SAM-e is as effective as conventional prescription medications in the treatment of depression</div>
								<div style="width: 100%;height: 20px;"></div>
								<div id="blue-dot">SAM-e is as effective as standard prescription medications (NSAIDs) in the treatment of osteoarthritis</div>
								<div style="width: 100%;height: 20px;"></div>
								<div id="blue-dot">SAM-e has significant benefits for patients suffering from various liver diseases</div>
								<div style="width: 100%;height: 20px;"></div>
			...
			<div id="vitamine" style="width: 100%;height: auto;">
				...
				<div class="vit-con" style="width: 100%;height:auto ;">
					...
					<div style="width: 100%;height: 20px;"></div>
					<div style="width: 96%;height: auto;margin: 0 auto; font-size: 12px;font-family: arial;line-height: 20px;">Vitamin is a natural nutritional supplement in the human body, which can affect human health</div>
			...
			<div id="fun-list" style="width: 100%;height: auto;">
				<div class="rep-style" style="width: 100%;height: auto;">
					<div style="width: 92%;height: auto;margin: 0 auto;">
						<img src="static/images/hm14.png" style="width: 100%;height: auto;" />
					</div>
				</div>
				<div style="width: 100%;height: 30px;"></div>
				<div class="rep-style" style="width: 100%;height: auto;">
