			...
			<div style="width: 96%;height: auto;margin: 0 auto;overflow: hidden;">
				...
				<div style="width: 100%;height: 40px;">
				 ...
				 <div style="width: 96%;height: auto;margin: 0 auto;">
				 	...
				 	<div style="width: 100%;height: auto;font-size: 14px;line-height: 22px;color: #666666;">Welcome to <i>HKG epi THERAPEUTICS Ltd.</i>  Before registering for trial, please read the following terms of service carefully.</div>
				 	<div style="width: 100%;height: 10px;"></div>
				 	<div style="width: 100%;height: auto;font-size: 16px;line-height: 50px;color: #0071BC;">About <i>EPIAGING APP</i></div>
				 	<div style="width: 100%;height: auto;font-size: 14px;line-height: 22px; color: #666666;"><i> EPIAGING APP</i> about to save your "blinded" personal medical data on the EpiAging Mobile App and the data analysis engine in the "cloud", which requires your information and consent. Your identity is blinded and you will be provided with an ID number. Your
            		...
            		<div style="width: 100%;height: 10px;"></div>
				 	...
				 	<div style="width: 100%;height: auto;font-size: 14px;line-height: 22px; color: #666666;">In accordance with the China Data Protection Regulations (CDPR) with regards to data protection, you have the right to request access to and rectification or erasure of your personal data or restriction of processing concerning your data or to object
         			   to processing as well as the right to data portability. You can exercise this right by contacting (info@epidia.cn).Your name and identity will be encrypted and firewalled. Following your signature you will receive a blinded ID that will allow you to provide data and remain anonymous to the system.</div>
           					<div style="width: 100%;height: 10px;"></div>
