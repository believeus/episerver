	...
	<body style="padding: 0;margin: 0;">
		...
		<jsp:include page="header.jsp"></jsp:include>
			<div style="width: 100%;height: auto;background-color: #F4F4F4;">
				...
				<div style="width: 100%;height: 10px;"></div>
				<div style="width: 100%;height: 30px;background-color: #F4F4F4">
							<div style=" width:90%;margin:0 auto; line-height: 20px;font-size: 12px;">Order NO.-11040717</div>
				</div>
				<div class="list" style="width: 100%;height: auto;overflow: hidden;background-color: #FFFFFF;">
					...
					<div style="width: 90%;height: auto;overflow: hidden;margin: 0 auto;">
						...
						<div style="width: 45%;height: auto;float: left;">
							...
							<div style="width: 100%;height: auto;font-size: 14px;font-weight: 500;line-height: 28px;">Sliva collection kit</div>
							
							<i style="font-size: 12px;">24/March/2019</i>
						</div>
						<div style="width: 28%;height: auto;float: left;">
							<div style="width: 100%;height: 26px;"></div>
							<div id="dot" style="width: 100%;height: 20px;color: #F36602;line-height: 30px; font-size: 16px;">$99.00</div>
